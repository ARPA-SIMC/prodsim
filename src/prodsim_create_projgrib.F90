PROGRAM prodsim_create_projgrib
USE log4fortran
...
INTEGER :: nx, ny, component_flag, projection_center_flag
...
opt = optionparser_new(description_msg= &
 ...
 &geographic projection in libsim are available', &
...
END PROGRAM prodsim_create_projgrib
